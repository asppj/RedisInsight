...
RUN yarn config set registry https://registry.npm.taobao.org/ && SKIP_POSTINSTALL=1 yarn install -registry=https://registry.npm.taobao.org/  --network-timeout 11000000
...
RUN yarn config set registry https://registry.npm.taobao.org/ && yarn install -registry=https://registry.npm.taobao.org/ --network-timeout 11000000
